import React, { message, useEffect, useState } from 'react'
...
import './Reviews.css'
 ...
 function Reviews({active, singleProduct,setSingleProduct }) {
    ...
    const hasReviews = singleProduct && Array.isArray(singleProduct.reviews);
     return (
        <div className={`tab-panel-reviews ${active}` }>
             {hasReviews &&singleProduct.reviews.length > 0 ? ( 
         <>
